...
public class AndroidClient {
	...
	private static final String baseURL = "http://wemeet.somee.com/WeMeetService.svc/json/";
	...
	public boolean UpdateLocation(String phoneNumber, String latitude,
	...
	public List<String> GetLocationRequests(String phoneNumber)
		...
		JSONArray array = new JSONArray(GetData(
				baseURL + "GetLocationRequests/" + phoneNumber).toString());
	...
	public boolean IsRequestSentTo(String fromPhoneNumber, String toPhoneNumber)
			throws Exception {
		return Boolean.parseBoolean(GetData(
